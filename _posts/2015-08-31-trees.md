...
```
While this is an effective and less expensive method of depth first traversing, the recursive method is often described instead, because it makes it more clear the step by step approach of travelling through to the extrema before moving back up the tree.
...
Let this sink in forever. I still wouldn't promise you I understand exactly what is happening, but it gets better each day.
